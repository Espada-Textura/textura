    ...
    <div>
      <div className="m-4">
        ...
        <div className=" p-3">
          ...
          <p>
            Welcome to <b>Espada</b> (“Company”, “we”, “our”, “us”)!
          </p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at <b>https://textura-art.web.app/</b>{" "}
          (together or individually “Service”) operated by <b>Espada</b>. Our
          ...
          and understood Agreements, and agree to be bound of them. If you do
          not agree with (or cannot comply with) Agreements, then you may not
          use the Service, but please let us know by emailing at{" "}
          <b>espada.team.official@gmail.com</b> so we can try to find a
        ...
        <div>
          ...
          <p>
            ...
            emailing at espada.team.official@gmail.com.
          </p>
        </div>
        ...
        <p>
          Espada has the right but not the obligation to monitor and edit all
          Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of Espada or used with permission. You may not distribute, modify,
        ...
        <p>
          ...
          property of Espada and its licensors. Service is protected by
          ...
          without the prior written consent of Espada.
        </p>
        <h5>
        ...
        <p>
          ...
          to espada.team.official@gmail.com, with the subject line: “Copyright
        ...
        <p>
          ...
          espada.team.official@gmail.com.
        </p>
        <h5>
          12. <b>Error Reporting and Feedback</b>
        </h5>
        <p>
          You may provide us either directly at espada.team.official@gmail.com
        ...
        <p>
          ...
          that are not owned or controlled by Espada.
        </p>
        <p>
          Espada has no control over, and assumes no responsibility for the
        ...
        <p>
          ...
          laws of Cambodia, which governing law applies to agreement without
        ...
        <p>
          ...
          email: <b>espada.team.official@gmail.com</b>.
        </p>
      </div>
    </div>
  );
